...
from . import views
from .views import dashboard, dashboard_orders, dashboard_order_details, add_a_category
...
urlpatterns = [
    ...
    path('dashboardeditproduct/<int:id>', edit_a_product, name='edit_a_product'),
